...
internal enum L10n {
  ...
  internal enum ChangepasswordScreen {
    /// Change password
    internal static let title = L10n.tr("Localizable", "changepassword_screen.title", fallback: "Change password")
    internal enum ButtonSavepassword {
      /// Save
      internal static let title = L10n.tr("Localizable", "changepassword_screen.button_savepassword.title", fallback: "Save")
    }
    internal enum FieldEmail {
      /// Password
      internal static let placeholder = L10n.tr("Localizable", "changepassword_screen.field_email.placeholder", fallback: "Password")
    }
  }
  internal enum Error {
    /// No time space left
  ...
  internal enum KidsScreen {
    ...
    internal static let emptyMessage = L10n.tr("Localizable", "kids_screen.empty_message", fallback: "Add kids by pressing +")
  ...
  internal enum ResetpasswordScreen {
    /// Reset password
    internal static let title = L10n.tr("Localizable", "resetpassword_screen.title", fallback: "Reset password")
    internal enum ButtonResetpassword {
      /// Send email with password
      internal static let title = L10n.tr("Localizable", "resetpassword_screen.button_resetpassword.title", fallback: "Send email with password")
    }
    internal enum FieldEmail {
      /// Email
    ...
    internal enum Message {
      /// Check your email
      internal static let title = L10n.tr("Localizable", "resetpassword_screen.message.title", fallback: "Check your email")
    }
  }
